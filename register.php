...
<div class="page">
  <div class="container" style="left:50%">
   ...
   <div style="color:darkblue; font-weight:500"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEenFLhhoz-KfFwnbomhaLIDN_BbOPmJpQQg&usqp=CAU"
      ...
      <div class="login" style="margin-top:25%">Sign up</div>
      <div class="eula" ></div>
    </div> 
    ...
    <div class="right" >
      ...
      <?php 
       ...
       <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <input onclick="location.href='login.php'" id="submit" value="Login">
    </div>       
        </form>
    </div>
...
.page {
  ...
  width: calc(100% - 40px);
  background-image: url("https://www.motorious.com/content/images/size/w1000/2020/12/Motorious---5--12.jpg");
