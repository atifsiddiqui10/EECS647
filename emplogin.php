...
// getting data from when form is submitted 
...
<div class="page">
  <div class="container" style="left:50%">
   ...
   <div style="color:darkblue; font-weight:500"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEenFLhhoz-KfFwnbomhaLIDN_BbOPmJpQQg&usqp=CAU"
      ...
      <div class="login" style="margin-top:4%">Admin Login</div>
    </div> 
...
.page {
  ...
  width: calc(100% - 40px);
  background-image: url("https://www.teahub.io/photos/full/248-2480097_black-hot-cars-wallpaper-24-desktop-background-car.jpg");
